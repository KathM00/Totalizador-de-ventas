...
describe('Calculadora de Totalizador', () => {
  ...
  it('debería calcular 3.5 de envio si el peso esta entre 11 y 20', () => {
    expect(calcularCostoEnvio(15)).toEqual(3.5);
  });

  it('debería calcular 5 de envio si el peso esta entre 21 y 40', () => {
  ...
  it('debería calcular 6.5 de envio si el peso esta entre 81 y 100', () => {
    expect(calcularCostoEnvio(90)).toEqual(6.5);
  });

  it('debería calcular 8 de envio si el peso esta entre 101 y 200', () => {
  ...
  it('debería calcular 0 de descuento si el cliente es Normal', () => {
    expect(calcularDescuentoCliente('Normal')).toEqual(0);
  });

  it('debería calcular 0.5 de descuento si el cliente es Recurrente', () => {
